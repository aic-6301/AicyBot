...
class Mod(commands.Cog):
    ...
    async def setup(self, ctx):
        if discord.utils.get(ctx.message.guild.roles, name='Muted') is None:
            ...
            guild = ctx.guild
            embed = discord.Embed(title='Setup', description='moderationのセットアップをしています', color=discord.Colour.from_rgb(160, 106, 84))
            embed.add_field(name='□ロールの設定をしています', value='Creating')
            e = discord.Embed(title='Setup', description='moderationのセットアップをしています', color=discord.Colour.from_rgb(160, 106, 84))
            ...
            em = discord.Embed(title='Setup', description='サーバーののセットアップをしています', color=discord.Colour.from_rgb(160, 106, 84))
            ...
            emb = discord.Embed(title='Setup', description='サーバーのセットアップをしています', color=discord.Colour.from_rgb(160, 106, 84))
